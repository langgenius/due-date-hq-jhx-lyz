...
VALUES
  ...
  ('40000000-0000-4000-8000-000000000002', 'CA FTB Newsroom', 'https://www.ftb.ca.gov/about-ftb/newsroom/index.html', 'mock/pulse/ca-ftb-llc-payment.html', CAST(unixepoch('2026-04-30 15:00:00') * 1000 AS INTEGER), 'CA FTB extends selected LLC payment deadlines by 30 days for San Diego County.', 'The Franchise Tax Board extends the LLC payment deadline to May 30, 2026 for San Diego County taxpayers.', 'CA', '["San Diego"]', '["ca_llc_franchise_min_800"]', '["llc"]', CAST(unixepoch('2026-04-30 00:00:00') * 1000 AS INTEGER), CAST(unixepoch('2026-05-30 00:00:00') * 1000 AS INTEGER), CAST(unixepoch('2026-04-30 15:00:00') * 1000 AS INTEGER), 0.92, 'approved', 'mock_user_manager_miguel', CAST(unixepoch('2026-04-30 16:00:00') * 1000 AS INTEGER), 1, 1, CAST(unixepoch('2026-04-30 15:10:00') * 1000 AS INTEGER), CAST(unixepoch('2026-05-01 09:50:00') * 1000 AS INTEGER));
