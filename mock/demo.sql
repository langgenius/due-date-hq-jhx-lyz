...
VALUES
  ...
  ('10000000-0000-4000-8000-000000000010', 'mock_firm_solo', 'Archive Solo Client', '10-1010101', 'CA', 'Orange', 'individual', 'archive@solo.test', 'Small second firm for switcher demo.', 'Sarah Martinez', 2, 0, NULL, NULL, NULL, NULL, CAST(unixepoch('2026-05-01 08:50:00') * 1000 AS INTEGER), CAST(unixepoch('2026-05-01 08:50:00') * 1000 AS INTEGER), NULL);
