...
| `/api/auth/*`            | better-auth（Google OAuth / One Tap / Microsoft OAuth + Organization + twoFactor） | 登录 / 注销 / OAuth callback / One Tap callback / 邀请接受 / 2FA / session 管理 | 浏览器 + OAuth 回调                                          |
