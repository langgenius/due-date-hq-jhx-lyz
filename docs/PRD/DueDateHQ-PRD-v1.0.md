...
| ---------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| **S1 · 申报季每周分诊**      | P0 · CORE           | 30 秒看清风险；**三段时间分组（This Week / This Month / Long-term）**；**筛选 < 1 秒响应**；一键标状态；5 分钟完成           | Dashboard（§5.1）+ Obligations 筛选/批量（§5.2）+ **AI Smart Priority**（§6.4）+ Penalty Radar（§6.3） |
