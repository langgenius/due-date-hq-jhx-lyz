...
| 版本 | 日期       | 作者  | 摘要                                                                                                                                                                                                                                                                                           |
| ---- | ---------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v1.7 | 2026-05-12 | Codex | 固定 `https://github.com/helloigig/DueDateHQ` Alerts 到当前 Rules > Pulse Changes 的产品映射：保留 firm-scoped Pulse Change 决策面，新增 impact-first 分层，不恢复独立 `/alerts`。                                                                                                             |
