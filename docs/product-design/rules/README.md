...
- pending template 可进入 preview/review queue，但不能写入 obligations、reminders 或 risk。
...
| 版本 | 日期       | 作者  | 摘要                                                                                                                                                                                                                                                                                           |
| ---- | ---------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v1.6 | 2026-05-05 | Codex | Rules 改为全局模板 + practice active rule 模型；owner/manager 审核后才可生产生成 obligations/reminders，pending templates 只进入 preview 和 Review Queue。                                                                                                                                     |
