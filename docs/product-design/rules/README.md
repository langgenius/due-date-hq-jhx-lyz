...
| 版本 | 日期       | 作者  | 摘要                                                                                                                                                                                                                                                                                             |
| ---- | ---------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| v1.5 | 2026-05-04 | Codex | Obligation Preview 增加第一版手动 Annual Rollover：用户先 preview，再 generate；source seeds 只取上一 filing year closed obligations，目标 obligation 只从 target filing year verified rules 生成，requires-review 且有具体 due date 的行以 `review` 进入 Obligations。                          |
