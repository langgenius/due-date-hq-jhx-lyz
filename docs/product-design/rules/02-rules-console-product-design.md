...
| 版本 | 日期       | 作者  | 摘要                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ---- | ---------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v1.0 | 2026-05-04 | Codex | Rules candidate verify 的 `Official extension form or method` 明确为自由输入 autocomplete：聚焦/输入时展示常见官方表格或办理方式建议，选择建议不会锁死字段，已选建议可再次点击或清空取消。详见 `docs/dev-log/2026-05-04-rules-candidate-verify-workflow.md`。                                                                                                                                                                                                                                                                                                 |
