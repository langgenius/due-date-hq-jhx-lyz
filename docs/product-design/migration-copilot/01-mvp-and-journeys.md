...
| Coverage transparency     | CA / NY 标 `demo_seed`，TX / FL / WA 标 `skeleton` 或 `state_review_needed`；Rules Console 按当前 active practice rules 展示 | 5 MVP states 逐格 practice-reviewed    | 把 pending coverage 说成 active           |
