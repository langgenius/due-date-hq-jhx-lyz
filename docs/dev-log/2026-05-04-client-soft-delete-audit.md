...
- Clients UI now shows a destructive confirmation in the fact profile drawer and invalidates
  Clients, Dashboard, and Workboard reads after deletion.
- Dashboard and Workboard read models now exclude soft-deleted clients so related obligation rows do
