...
- **后续扩展有固定入口。** Obligations 后续加 saved view、Rules Console 后续加 drawer /
...
| Obligations    | `apps/app/src/routes/obligations.tsx` | 改为导出 `obligationsSearchParamsParsers` + `ObligationsSearchParams`。 |
...
- `apps/app/src/routes/obligations.tsx`
  - `obligationsSearchParamsParsers` 重命名为 `obligationsSearchParamsParsers`。
  - 新增 `ObligationsSearchParams`。
...
- `docs/dev-file/12-Marketing-Architecture.md`、locale handoff devlog、Obligations
  devlog、Rules Console tab devlog 已同步到当前实现。

## 验证

- `pnpm exec vp check --fix apps/app/src/i18n/query.ts apps/app/src/routes/obligations.tsx apps/app/src/features/rules/rules-console.tsx apps/app/src/features/rules/rules-console-model.ts apps/app/src/features/rules/rules-console-model.test.ts docs/dev-file/05-Frontend-Architecture.md docs/dev-file/12-Marketing-Architecture.md docs/dev-log/2026-04-26-marketing-locale-handoff-nuqs.md docs/dev-log/2026-04-28-obligations-tanstack-table-url-state.md docs/dev-log/2026-04-28-rules-console-tab-url-state.md docs/dev-log/2026-04-28-nuqs-query-contract-sweep.md`
