...
- Redacted Smart Priority factor breakdowns from Dashboard and Obligations responses for non-owners,
  so configured weight proportions are not exposed through row popovers or detail panels.
- Tightened Obligations dollar redaction by omitting penalty amount breakdowns when the role cannot
  see dollar values.
...
- `pnpm exec vp check apps/app/src/features/permissions/permission-gate.tsx apps/app/src/routes/practice.tsx apps/app/src/features/calendar/calendar-page.tsx apps/app/src/features/priority/SmartPriorityBadge.tsx apps/app/src/routes/obligations.tsx apps/server/src/procedures/firms/index.ts apps/server/src/procedures/firms/index.test.ts apps/server/src/procedures/dashboard/index.ts apps/server/src/procedures/obligations/index.ts packages/contracts/src/firms.ts packages/contracts/src/contracts.test.ts docs/dev-log/2026-05-03-permission-obscured-cards.md`
